...
// TODO:these don't cover all the edge cases, so need improving, luckily, the edges are very blurred with approximations, so you probably won't notice the difference!
